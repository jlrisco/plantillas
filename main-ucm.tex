% Created 2026-01-27 mar 10:59
% Intended LaTeX compiler: pdflatex
\documentclass[t, smaller]{beamer}
...
\section{Sección 1}
\label{sec:orgc015b5e}

\begin{frame}[label={sec:org6e34beb}]{Diapositiva 1}
...
\begin{frame}[label={sec:org571b88a}]{Diapositiva 2}
...
\label{sec:org6872a81}

\begin{frame}[label={sec:org9dcde62}]{Autores}
\begin{itemize}
\item Risco Martín, José Luis
\end{itemize}
\end{frame}

\begin{frame}[label={sec:orgc5dc396}]{Licencia}
