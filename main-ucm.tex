...
\section{Sección 1}
\label{sec:org2ebb8c3}

\begin{frame}[label={sec:orgec208d9}]{Diapositiva 1}
...
\begin{frame}[label={sec:orgbea7517}]{Diapositiva 2}
...
\label{sec:org02a13c8}

\begin{frame}[label={sec:orgd95936e}]{Autores}
\begin{itemize}
\item Risco Martín, José Luis
\end{itemize}
\end{frame}

\begin{frame}[label={sec:org92c6177}]{Licencia}
